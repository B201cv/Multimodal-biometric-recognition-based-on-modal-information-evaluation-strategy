...
def testmodel():
    ...
    class TestData(Dataset):
        ...
        def __getitem__(self, idx):
            ...
            for sample1_index in  range(1,4):
            # sample2_index =range(0,4)
            # for item in a:
            #     if sample1_index == item:
            #         sample1_index = random.sample(range(length1_imgs), 1)
            # for item1 in b:
            #     if sample2_index == item1:
            #         sample2_index = random.sample(range(length2_imgs), 1)
            # a.append(sample1_index)
            # b.append(sample2_index)
                print_img_path = print_imgs_path[sample1_index]
                vein_img_path = vein_imgs_path[sample1_index]
